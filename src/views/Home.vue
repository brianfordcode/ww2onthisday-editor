  ...
  methods: {
    ...
    enterBook() {
      if (this.bookInput.title === '' || this.bookInput.picture === '' ||
        ...
        this.bookInput.id = ''
        this.bookInput.title = ''
        this.bookInput.picture = ''
        this.bookInput.year = ''
        this.bookInput.mediaLink.link = ''
        this.bookInput.mediaLink.affiliate = null
        this.bookInput.mediaLink.affiliateSource = ''
    ...
    enterMovie() {
      ...
      this.movieInput.id = ''
      this.movieInput.title = ''
      this.movieInput.picture = ''
      this.movieInput.year = ''
      this.movieInput.mediaLink.link = ''
      this.movieInput.mediaLink.affiliate = null
      this.movieInput.mediaLink.affiliateSource = ''
    },
    editMovie(index) {
